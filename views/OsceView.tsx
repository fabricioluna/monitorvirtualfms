  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 pb-40">
      <div className="flex justify-between items-center mb-10 border-b pb-6">
        <button onClick={onBack} className="text-[#003366] font-black uppercase text-xs flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white p-8 rounded-[2rem] shadow-xl border-t-8 border-[#003366]">
            <h3 className="text-[10px] font-black text-[#003366] uppercase mb-4 tracking-widest">📋 Cenário Clínico</h3>
            <p className="text-gray-600 leading-relaxed text-sm italic">"{station.scenario}"</p>
          </div>
          ...
          {!isFinished && (
            <div className="bg-white p-6 rounded-2xl border border-gray-100 flex items-center justify-between">
              <span className="text-[10px] font-black text-gray-400 uppercase">Cronômetro</span>
